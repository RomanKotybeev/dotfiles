...
(def-doom-theme lightcolt
  ...
  (((line-number &override) :foreground base4)
   ...
   ((markdown-code-face &override) :foreground comments :background bg)
   ((markdown-pre-face &override) :foreground comments :background bg)
   ((markdown-url-face &override) :foreground comments :background bg)
