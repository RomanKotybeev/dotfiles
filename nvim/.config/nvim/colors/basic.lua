...
local palette = {
    basebg = { gui='#f0f0f0', cterm=0 },
    basefg = { gui='#1a1a1a', cterm=0 },
    darkest = { gui='#000000', cterm=0 },
    gray = { gui='#888888', cterm=0 },
    mediumgray = {gui='#bbbbbb', cterm=0},
    lightgray  = { gui='#e5e5e5', cterm=0 },
...
Group.new('MatchParen', c.redish, c.none, s.none)
...
Group.new('LineNr',  c.gray, c.lightgray, s.none)
...
Group.new('GitSignsAdd',  c.green, c.lightgray,  s.bold)
Group.new('GitSignsChange',  c.orange, c.lightgray,  s.bold)
Group.new('GitSignsDelete',  c.purple, c.lightgray,  s.bold)
...
Group.new('Number',      c.green, c.none,  s.none)
