...
static const char *filemanager[] = { TERMINAL, "-e", "vifm", NULL };
static const char *screenshot[] = { "flameshot", "gui", NULL };

static Key keys[] = {
	/* modifier                     key        function        argument */
    { 0,              XF86XK_AudioMute,        spawn,          {.v = mutecmd } },
    { 0,              XF86XK_AudioLowerVolume, spawn,          SHCMD("amixer -q sset PCM 5%- unmute; kill -46 $(pidof dwmblocks)") },
    { 0,              XF86XK_AudioRaiseVolume, spawn,          SHCMD("amixer -q sset PCM 5%+ unmute; kill -46 $(pidof dwmblocks)") },
